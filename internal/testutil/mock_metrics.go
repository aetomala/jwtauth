...
//
//	mockgen -source=interface.go -destination=../../internal/testutil/mock_metrics.go -package=testutil -mock_names=Metrics=MockMetrics
//
...
func (m *MockMetrics) RecordDuration(name string, duration time.Duration, labels map[string]string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RecordDuration", name, duration, labels)
}

// RecordDuration indicates an expected call of RecordDuration.
func (mr *MockMetricsMockRecorder) RecordDuration(name, duration, labels any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecordDuration", reflect.TypeOf((*MockMetrics)(nil).RecordDuration), name, duration, labels)
}
